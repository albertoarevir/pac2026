    ...
    <div class="col-md-6">
          <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                          ...
                          <form action="{{ route('estadocompras.update', $estadocompras->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                <!--{{method_field('Patch')}}-->
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <input value="{{$estadocompras->detalle}}" type="text" name="detalle" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>                                  
                                    </div>
...
<hr> 
                                    <div class="row">
                                      <div class="d-grid gap-2 d-md-block">
                                              ...
                                              <a href="{{ url('estadocompras') }}" class="btn btn-primary"><i
