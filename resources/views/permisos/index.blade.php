...
@section('content')
    <div class="row">
        <div class="col-md-6" style="margin-left: 30px">
            <h3>Listado de Permisos registrados</h3>
            <br>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            {{--
                                                <a href="{{ url('permisos/' . $permiso->id) }}" type="button"
            ...
            <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Administración de Permiso</h4>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-10">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ old('Permiso') }}"
                                                                                name="Permiso" class="form-control" maxlength="50"
                                                                                required
