...
@section('content')
    <div class="row" style="margin-left: 2px">
        <h2 style="font-size: 30px; color:rgb(218, 13, 13); margin-bottom: 3; margin-left: 35px;">
            ID Identificador de la Licitación N°: {{ $pac ? str_pad($pac->id, 4, '0', STR_PAD_LEFT) : 'N/A' }}
        </h2> 
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id_proyecto" value={{$pac->id}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="texto" value="{{ old('numero') }}" name="numero" maxlength="12" class="form-control"
                                        required>
                                    @error('numero')
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <a href="{{ url('ordenes/') }}" class="btn btn-success">Volver al listado de licitaciones</a>
